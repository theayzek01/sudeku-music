...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('iliskim')
    .setDescription('Sude ile arandaki samimiyet ve aşk düzeyini ölçer.'),
  ...
  run: async (client, interaction) => {
    ...
    if (rel.level === 'Düşman') {
      comment = 'ay cidden senden nefret ediyorum ya... benden uzak dur bebeğim cidden bas git...';
      emoji = '🖤';
      accentColor = '#27272a';
      ...
      comment = 'fena değil ya tatlı arkadaşız bence. sohbetin yarıyor kanka fln...';
      emoji = '🌸';
      accentColor = '#10b981';
